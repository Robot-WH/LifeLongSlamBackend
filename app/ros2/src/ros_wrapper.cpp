...
#include "lifelong_backend/msg/keyframe_info.hpp"
...
public:  
    RosWrapper() : Node("backend_node") {  
        // publisher_ = this->create_publisher<std_msgs::msg::Int32>("backend_node", 10);  
        // timer_ = this->create_wall_timer(  
        //     std::chrono::milliseconds(500), std::bind(&Talker::timer_callback, this));  
    }
private:
    // 发布者成员变量  
    ...
    // rclcpp::Publisher<lifelong_backend::msg::WorkspaceInfo>::SharedPtr workspace_pub_; 
    // 订阅者成员变量  
    rclcpp::Subscription<lifelong_backend::msg::KeyframeInfo>::SharedPtr keyframe_sub_; // 假设消息类型  
    // rclcpp::Subscription<std_msgs::msg::String>::SharedPtr get_work_space_sub_; // 使用 String 作为示例  
};
